...
void serialize_engine(std::string &wts_name, std::string &engine_name, int& is_p, std::string &sub_type, float &gd, float &gw, int &max_channels) {
...
bool parse_args(int argc, char **argv, std::string &wts, std::string &engine, int& is_p, std::string &img_dir, std::string &sub_type,
...
int main(int argc, char **argv) {
    ...
    if (!parse_args(argc, argv, wts_name, engine_name, is_p, img_dir, sub_type, cuda_post_process, gd, gw, max_channels)) {
